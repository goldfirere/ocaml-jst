...
let tvar_none_any = Tvar { name = None; kkind = Kkind.any }
let tvar_none_imm = Tvar { name = None; kkind = Kkind.immediate }
let tvar_none_imm64 = Tvar { name = None; kkind = Kkind.immediate64 }
let tvar_none_val = Tvar { name = None; kkind = Kkind.value }
let tvar_none_void = Tvar { name = None; kkind = Kkind.void }

let tunivar_none_any = Tunivar { name = None; kkind = Kkind.any }
let tunivar_none_imm = Tunivar { name = None; kkind = Kkind.immediate }
let tunivar_none_imm64 =
  Tunivar { name = None; kkind = Kkind.immediate64 }
let tunivar_none_val = Tunivar { name = None; kkind = Kkind.value }
let tunivar_none_void = Tunivar { name = None; kkind = Kkind.void}

let norm = function
  | (Tvar { name = None; kkind }) as t -> begin
      match Kkind.get kkind with
  ...
  | (Tunivar { name = None; kkind }) as t -> begin
      match Kkind.get kkind with
...
*)
  | _ ->
    ...
    (* Make a stub *)
    let kkind = Kkind.any in
    let ty' =
      if s.for_saving then newpersty (Tvar {name = None; kkind})
      else newgenstub ~scope:(get_scope ty) kkind
    in
    For_copy.redirect_desc copy_scope ty (Tsubst (ty', None));
    let desc =
