...
val make_matrix : int -> int -> 'a -> 'a iarray iarray
...
val with_array : int -> 'a -> local_ (local_ 'a array -> 'b) -> 'a iarray * 'b

val with_array' : int -> 'a -> local_ (local_ 'a array -> unit) -> 'a iarray
